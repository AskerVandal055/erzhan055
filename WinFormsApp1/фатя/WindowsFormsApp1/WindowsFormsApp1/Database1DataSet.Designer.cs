...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BooksRow AddBooksRow(string Title, string Author, int Year, string Genre) {
...
namespace WindowsFormsApp1.Database1DataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([Title], [Author], [Year], [Genre]) VALUES (@Title, @A" +
                "uthor, @Year, @Genre);\r\nSELECT ID, Title, Author, Year, Genre FROM Books WHERE (" +
                "ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Title] = @Title, [Author] = @Author, [Year] = @Year, [Genre] = @Genre WHERE (([ID] = @Original_ID) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)) AND ((@IsNull_Genre = 1 AND [Genre] IS NULL) OR ([Genre] = @Original_Genre)));
SELECT ID, Title, Author, Year, Genre FROM Books WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Title, Author, Year, Genre FROM dbo.Books";
        ...
        public virtual int Delete(int Original_ID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_Year, string Original_Genre) {
        ...
        public virtual int Insert(string Title, string Author, global::System.Nullable<int> Year, string Genre) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, string Author, global::System.Nullable<int> Year, string Genre, int Original_ID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_Year, string Original_Genre, int ID) {
            if ((Title == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Author, global::System.Nullable<int> Year, string Genre, int Original_ID, string Original_Title, string Original_Author, global::System.Nullable<int> Original_Year, string Original_Genre) {
            return this.Update(Title, Author, Year, Genre, Original_ID, Original_Title, Original_Author, Original_Year, Original_Genre, Original_ID);
        }
    }
